namespace Crazy2018WorkFlow {
    ...
    #line 20 "C:\Users\Game\Desktop\Whirl2019_Sites\Crazy2018WorkFlow\Workflow1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "C:\Users\Game\Desktop\Whirl2019_Sites\Crazy2018WorkFlow\Workflow1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 21 "C:\Users\Game\Desktop\Whirl2019_Sites\Crazy2018WorkFlow\Workflow1.xaml"
    ...
    #line 22 "C:\Users\Game\Desktop\Whirl2019_Sites\Crazy2018WorkFlow\Workflow1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 23 "C:\Users\Game\Desktop\Whirl2019_Sites\Crazy2018WorkFlow\Workflow1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 24 "C:\Users\Game\Desktop\Whirl2019_Sites\Crazy2018WorkFlow\Workflow1.xaml"
    using System.Text;
    ...
    public partial class Workflow1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            if (((isReference == false) 
                        && ((expressionText == "v1+v2") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 0;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "v3.ToString()") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 1;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "argument1+argument2") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 2;
                return true;
            }
            if (((isReference == true) 
                        && ((expressionText == "argument3") 
                        && (Workflow1_TypedDataContext2.Validate(locations, true, 0) == true)))) {
                expressionId = 3;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "argument3.ToString()") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 4;
                return true;
            }
        ...
        private class Workflow1_TypedDataContext1 : Workflow1_TypedDataContext0 {
            ...
            protected override void GetValueTypeValues() {
                this.argument1 = ((double)(this.GetVariableValue((0 + locationsOffset))));
                this.argument3 = ((double)(this.GetVariableValue((1 + locationsOffset))));
                this.argument2 = ((double)(this.GetVariableValue((2 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((0 + locationsOffset), this.argument1);
                this.SetVariableValue((1 + locationsOffset), this.argument3);
                this.SetVariableValue((2 + locationsOffset), this.argument2);
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 1)].Name != "argument3") 
        ...
        private class Workflow1_TypedDataContext2 : Workflow1_TypedDataContext1 {
            ...
            internal System.Linq.Expressions.Expression @__Expr3GetTree() {
                ...
                #line 61 "C:\USERS\GAME\DESKTOP\WHIRL2019_SITES\CRAZY2018WORKFLOW\WORKFLOW1.XAML"
          ...
          argument3 = value;
            ...
            protected override void GetValueTypeValues() {
                this.v1 = ((int)(this.GetVariableValue((3 + locationsOffset))));
                this.v2 = ((int)(this.GetVariableValue((4 + locationsOffset))));
                this.v3 = ((int)(this.GetVariableValue((5 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((3 + locationsOffset), this.v1);
                this.SetVariableValue((4 + locationsOffset), this.v2);
                this.SetVariableValue((5 + locationsOffset), this.v3);
                base.SetValueTypeValues();
            }
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 3)].Name != "v1") 
                            || (locationReferences[(offset + 3)].Type != typeof(int)))) {
                    return false;
                }
                if (((locationReferences[(offset + 4)].Name != "v2") 
                            || (locationReferences[(offset + 4)].Type != typeof(int)))) {
                    return false;
                }
                if (((locationReferences[(offset + 5)].Name != "v3") 
        ...
        private class Workflow1_TypedDataContext2_ForReadOnly : Workflow1_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 49 "C:\USERS\GAME\DESKTOP\WHIRL2019_SITES\CRAZY2018WORKFLOW\WORKFLOW1.XAML"
          ...
          v1+v2;
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 55 "C:\USERS\GAME\DESKTOP\WHIRL2019_SITES\CRAZY2018WORKFLOW\WORKFLOW1.XAML"
        ...
        v3.ToString();
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 66 "C:\USERS\GAME\DESKTOP\WHIRL2019_SITES\CRAZY2018WORKFLOW\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<double>> expression = () => 
          argument1+argument2;
          ...
          argument1+argument2;
            ...
            internal System.Linq.Expressions.Expression @__Expr4GetTree() {
                ...
                #line 72 "C:\USERS\GAME\DESKTOP\WHIRL2019_SITES\CRAZY2018WORKFLOW\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
        argument3.ToString();
