...
{
  public  class SiteConfig:SysCruxDataStatistics
    {
        ...
        private string _sysencryptstring = "Loach";
    ...
    public class SysCruxDataStatistics
    {
        public SysCruxDataStatistics()
        {
            totaltable = 0;
            Openingtable = 0;
            Todaytax = 0;
        ...
        /// 在游戏的房间
        /// </summary>
        public int Openingtable { get; set; }
        /// <summary>
        /// 今日总税收
        /// </summary>
        public long? Todaytax { get; set; }

        /// <summary>
        /// 今日流水
        /// </summary>
        public long? TodayliuWater { get; set; }
        /// <summary>
        /// 总奖池
        /// </summary>
