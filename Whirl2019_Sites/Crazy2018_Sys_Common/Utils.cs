...
namespace Crazy2018_Sys_Common
{
    public class Utils
    {
        ...
        public static long GetTimeStampHm()
        {
        ...
        public static string Removebyte(string name)
        {
        ...
        public static string OutPageListForBt(int pageSize, int pageIndex, int totalCount)
        {
            //计算页数
        ...
        /// <returns></returns>
        public static string OutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize, bool isApi = false)
        {
            //计算页数
            if (totalCount < 1 || pageSize < 1)
            {
            ...
            if (!isApi)
            {
                ...
                lastBtn = "<a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex + 1).ToString()) + "\">下一页»</a>";
                lastStr = "<a href=\"" + ReplaceStr(linkUrl, pageId, pageCount.ToString()) + "\">" + pageCount.ToString() + "</a>";
            }
            else {
                ...
                firstStr = "<a>1</a>";
                lastBtn = "<a>下一页»</a>";
                lastStr = "<a>" + pageCount.ToString() + "</a>";
            }
        ...
        public static Dictionary<string, object> SortDictionary(Dictionary<string, object> sArray)
        {
        ...
        /// <returns></returns>
        public static string GetUrlString(Dictionary<string, object> data)
        {
            var str = string.Empty;
            if (data != null)
            {
        ...
        public static string HttpPost2(string url, string param, string hkey)
        {
            HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create(url);
            request.Method = "POST";
        ...
        public static bool IsHanZi(string str)
        {
            ...
            return cn.IsMatch(str);
        }
        public static string GetBankCode(string name)
        {
            var data = GetBankName();
            return data[name];
        }


        public static Dictionary<string,string> GetBankName()
        {
            Dictionary<string, string> request = new Dictionary<string, string>();
            request.Add("中国银行", "HPT00001");
            request.Add("中国工商银行", "HPT00002");
            request.Add("中国建设银行", "HPT00003");
            request.Add("中国农业银行", "HPT00004");
            request.Add("招商银行", "HPT00005");
            request.Add("交通银行", "HPT00006");
            request.Add("中信银行", "HPT00007");
            request.Add("兴业银行", "HPT00008");
            request.Add("中国民生银行", "HPT00009");
            request.Add("华夏银行", "HPT00010");
            request.Add("上海发展银行", "HPT00011");
            request.Add("汇丰银行", "HPT00012");
            request.Add("渣打银行", "HPT00013");
            request.Add("花旗银行", "HPT00014");
            request.Add("德意志银行", "HPT00015");
            request.Add("瑞士银行", "HPT00016");
            request.Add("荷兰银行", "HPT00017");
            request.Add("香港汇丰", "HPT00018");
            request.Add("香港花旗", "HPT00019");
            request.Add("香港东亚银行", "HPT00020");
            request.Add("恒生银行", "HPT00021");
            request.Add("中国光大银行", "HPT00022");
            request.Add("广发银行", "HPT00023");
            request.Add("平安银行", "HPT00024");
            request.Add("北京银行", "HPT00025");
            request.Add("中国邮政储蓄银行", "HPT00026");
            request.Add("上海银行", "HPT00027");
            request.Add("南京银行", "HPT00028");
            request.Add("渤海银行", "HPT00029");
            request.Add("宁波银行", "HPT00030");
            request.Add("深圳发展银行", "HPT00031");
            request.Add("北京农商银行", "HPT00032");
            request.Add("上海农商银行", "HPT00033");
            request.Add("浙江稠州商业银行", "HPT00034");
            request.Add("杭州银行", "HPT00035");
            request.Add("富滇银行", "HPT00036");
            request.Add("浙商银行", "HPT00037");
            request.Add("河北银行", "HPT00038");
            request.Add("徽商银行", "HPT00039");
            request.Add("人民银行（ 央行）", "HPT00040");
            request.Add("广州银行", "HPT00041");
            request.Add("哈尔滨银行", "HPT00042");
            request.Add("长沙银行", "HPT00043");
            request.Add("青岛银行", "HPT00044");
            request.Add("上饶银行", "HPT00045");
            request.Add("东莞银行", "HPT00046");
            request.Add("临商银行", "HPT00047");
            request.Add("内蒙古银行", "HPT00048");
            request.Add("华融湘江银行", "HPT00049");
            request.Add("南充市商业银行", "HPT00050");
            request.Add("台州银行", "HPT00051");
            request.Add("吉林银行", "HPT00052");
            request.Add("国家开发银行", "HPT00053");
            request.Add("大连银行", "HPT00054");
            request.Add("天津农商银行", "HPT00055");
            request.Add("天津银行", "HPT00056");
            request.Add("威海市商业银行", "HPT00057");
            request.Add("宁夏银行", "HPT00058");
            request.Add("宜宾市商业银行", "HPT00059");
            request.Add("平顶山银行", "HPT00060");
            request.Add("廊坊银行", "HPT00061");
            request.Add("德州银行", "HPT00062");
            request.Add("恒丰银行", "HPT00063");
            request.Add("成都农商银行", "HPT00064");
            request.Add("成都银行", "HPT00065");
            request.Add("承德银行", "HPT00066");
            request.Add("昆仑银行", "HPT00067");
            request.Add("汉口银行", "HPT00068");
            request.Add("洛阳银行", "HPT00069");
            request.Add("济宁银行", "HPT00070");
            request.Add("浙江民泰商业银行", "HPT00071");
            request.Add("浙江泰隆商业银行", "HPT00072");
            request.Add("温州银行", "HPT00074");
            request.Add("湖北银行", "HPT00075");
            request.Add("潍坊银行", "HPT00076");
            request.Add("盛京银行", "HPT00077");
            request.Add("石嘴山银行", "HPT00078");
            request.Add("福建海峡银行", "HPT00079");
            request.Add("绍兴银行", "HPT00080");
            request.Add("苏州银行", "HPT00081");
            request.Add("莱商银行", "HPT00082");
            request.Add("营口银行", "HPT00083");
            request.Add("衡水银行", "HPT00084");
            request.Add("西安银行", "HPT00085");
            request.Add("赣州银行", "HPT00086");
            request.Add("邢台银行", "HPT00087");
            request.Add("郑州银行", "HPT00088");
            request.Add("鄂尔多斯银行", "HPT00089");
            request.Add("重庆三峡银行", "HPT00090");
            request.Add("锦州银行", "HPT00091");
            request.Add("陕西信合", "HPT00092");
            request.Add("青海银行", "HPT00093");
            request.Add("韩亚银行", "HPT00094");
            request.Add("齐商银行", "HPT00095");
            request.Add("齐鲁银行", "HPT00096");
            request.Add("龙江银行", "HPT00097");
            return request;
        }
        ...
        public static string AESEncryptToString(object rawData, string AES_KEY, string AES_IV, char[] padding)
        {
            return AESEncryptToString(JsonConvert.SerializeObject(rawData), AES_KEY, AES_IV, padding);
        }
        public static string AESEncryptToString(string JsonString, string AES_KEY, string AES_IV, char[] padding)
        {
            var aESEncryptBytes = AESEncrypt(JsonString, AES_KEY, AES_IV);
            var URL_Safe_AESEncrypt_String = Convert.ToBase64String(aESEncryptBytes)
            .TrimEnd(padding).Replace('+', '-').Replace('/', '_');
            return URL_Safe_AESEncrypt_String;
        }
        private static byte[] AESEncrypt(string plainText, string AES_KEY, string AES_IV)
        {
            using (SymmetricAlgorithm des = Rijndael.Create())
            {
                byte[] inputByteArray = Encoding.UTF8.GetBytes(plainText);
                des.Key = Encoding.UTF8.GetBytes(AES_KEY);
                des.IV = Encoding.UTF8.GetBytes(AES_IV);
                var encrypter = des.CreateEncryptor();
                byte[] cipherBytes = encrypter.TransformFinalBlock(inputByteArray, 0,
               inputByteArray.Length);
                return cipherBytes;
            }
        }

        public static string AesDecryptBase64(string sourceStr, string AES_KEY, string AES_IV)
        {
            string decrypt = "";
            try
            {
