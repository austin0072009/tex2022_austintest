  ...
  public  class DTRequest
    {
        ...
        public static bool IsSearchEnginesGet()
        {
            ...
            string[] SearchEngine = { "google", "yahoo", "msn", "baidu", "sogou", "sohu", "sina", "163", "lycos", "tom", "yisou", "iask", "soso", "gougou", "rootsou" };
        ...
        private static string GetUrl(string key)
        {
            ...
            return StringHelper.Decrypto(strTxt.ToString(), key);
        }
