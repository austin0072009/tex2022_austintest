...
namespace Crazy2018_Sys_DBHelper
{
    ...
    public partial class chesscarddbEntities : DbContextBase
    {
        public chesscarddbEntities()
            : base("chesscarddbEntities")
        {
        }
        ...
        public virtual DbSet<dt_channel_site> dt_channel_site { get; set; }
