...
namespace ETModel
{
    ...
    public sealed class TChannel : AChannel
    {
        ...
        public TChannel(IPEndPoint ipEndPoint, TService service) : base(service, ETChannelType.Connect)
        {
        ...
        public TChannel(Socket socket, TService service) : base(service, ETChannelType.Accept)
        {
            int packetSize = service.PacketSizeLength;
            this.packetSizeCache = new byte[packetSize];
            this.memoryStream = service.MemoryStreamManager.GetStream("message", ushort.MaxValue);
        ...
        public string GetIP()
        {
            ...
            return socket.LocalEndPoint == null ? (socket.RemoteEndPoint == null ? null : socket.RemoteEndPoint.ToString()) : socket.LocalEndPoint.ToString();
        }
        ...
        public override void Send(byte[] bytes)
        {
            ...
            switch (this.GetService().PacketSizeLength)
            {
                case Packet.PacketSizeLength4:
                    ...
                    {
                        throw new Exception($"send packet too large: {bytes.Length}");
                    }
                ...
                case Packet.PacketSizeLength2:
                    ...
                    this.packetSizeCache.WriteTo(0, (ushort)bytes.Length);
                    break;
                default:
                    throw new Exception("packet size must be 2 or 4!");
            }
