...
namespace ETModel.Framework.Common.Serialization
{
    /// <summary>
    /// Protobuf序列化与反序列化
    /// </summary>
    public static class ProtoBufUtils
    {
        ...
        public static RuntimeTypeModel TypeModel { get { return typeModel; } private set { typeModel = value; } }
        /// <summary>
        ...
        public static void LoadProtobufType(Assembly assembly)
        {
            ...
            for (int i = 0; i < types.Count; i++)
            {
                ...
                if (!myEntity.FullName.Contains(".Script.Model.")) continue;
                //获得所有属性
