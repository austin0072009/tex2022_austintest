...
namespace ETTools
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            ProcessHelper.Run(protoc, "--csharp_out=\"../Server/Model/Module/Message/\" --proto_path=\"./\" OuterMessage.proto", waitExit: true);
            ProcessHelper.Run(protoc, "--csharp_out=\"../Server/Model/Module/Message/\" --proto_path=\"./\" HotfixMessage.proto", waitExit: true);
        ...
        private const string clientMessagePath = "../Server/Model/Module/Message/";
        private const string hotfixMessagePath = "../Server/Model/Module/Message/";
