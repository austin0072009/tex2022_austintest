(function () {
    ...
    require.register("pinusnode-pinus-jsclient-websocket/lib/pinus-client.js", function (exports, require, module) {
        (function () {
            ...
            var enCode = null;
            var deCode = null;
            var ActorMessageCallback = null;
            pinus.init = function (params, cb, en, de) {
                initCallback = cb;
            ...
            pinus.setActorMessageCallback = function (cb) {
                ActorMessageCallback = cb
            };
            ...
            var onData = function (data) {
                ...
                var msg = deCode(data)
                console.log(data.fn + " rec  onmessage: ", msg);
                if (msg.RpcId > 0) {
                    msg.route = routeMap[msg.RpcId];
                    delete routeMap[msg.RpcId];
                    if (!msg.route) {
                        return;
                    }

                } else {
                    if (ActorMessageCallback) {
                        ActorMessageCallback(msg);
                    }
                }
                processMessage(msg);
            ...
            var processPackage = function (msg) {
                handlers[Package.TYPE_DATA](msg);
            };

            var processMessage = function (msg) {

                var cb = callbacks[msg.RpcId];

                delete callbacks[msg.RpcId];
                if (typeof cb !== "function") {
                    return;
                }
                console.log("test log:" + msg.result);
                cb(msg);
                return;
            };
    ...
    require.alias(
        "pinusnode-pinus-jsclient-websocket/lib/pinus-client.js",
        "boot/deps/pinus-jsclient-websocket/lib/pinus-client.js"
    );
    require.alias(
        "pinusnode-pinus-jsclient-websocket/lib/pinus-client.js",
        "boot/deps/pinus-jsclient-websocket/index.js"
    );
    require.alias(
        "pinusnode-pinus-jsclient-websocket/lib/pinus-client.js",
        "pinusnode-pinus-jsclient-websocket/index.js"
    );
